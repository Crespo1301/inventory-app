...
Purpose: Restaurant inventory and ordering product experiment, currently lower priority while free-tier resources are managed.
Voice: Kitchen-practical, fast, and workflow-first. Explain value through missed orders, overordering, and weekly ordering pain.
